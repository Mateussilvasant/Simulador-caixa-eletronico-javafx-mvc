...
import br.com.bancoms.view.BancoMS;
...
public class TecladoView extends Group {
    ...
    public TecladoView(TecladoAdapter tecladoAdapter) {
        double paddingBox = BancoMS.METRICS.getPX(0.0060);

        vboxView = new VBox();
        vboxView.setSpacing(BancoMS.METRICS.getPX(0.008));
        ...
        numeroField.setFont(Font.font(BancoMS.METRICS.getPX(0.008)));
        numeroField.getStyleClass().add("numeroField");

        gridBotoes = new GridPane();
        gridBotoes.setAlignment(Pos.CENTER);
        gridBotoes.setHgap(BancoMS.METRICS.getPX(0.002));
        gridBotoes.setVgap(BancoMS.METRICS.getPX(0.002));


        HBox hboxButton = new HBox();
        hboxButton.setAlignment(Pos.CENTER);
        hboxButton.setSpacing(BancoMS.METRICS.getPX(0.002));
    ...
    private void adicionarBotao(int l, int c, int indice, TecladoAdapter tecladoAdapter) {
        ...
        botao.setFont(Font.font(BancoMS.METRICS.getPX(0.012)));
