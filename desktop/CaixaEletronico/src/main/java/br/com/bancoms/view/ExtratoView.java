...
public class ExtratoView extends VBox {
    ...
    private ComboBox<String> tipoMovimentoOpcao;
    private ComboBox<String> diasOpcao;
    ...
    public ExtratoView(ExtratoController extratoController) {
        ...
        setFillWidth(false);
        setTranslateY(getTranslateY() + BancoMS.METRICS.getPX(0.010));
        ...
        tipoMovimentoLabel.setFont(Font.font(BancoMS.METRICS.getPX(0.008)));

        Label periodoLabel = new Label("Período: ");
        periodoLabel.getStyleClass().add("labelStyleDark");
        periodoLabel.setFont(Font.font(BancoMS.METRICS.getPX(0.008)));

        labelExtrato = new TextFlow();

        Text ola = new Text("Olá ");
        ola.getStyleClass().add("labelStyleDark");
        ola.setFont(Font.font(BancoMS.METRICS.getPX(0.009)));
        ...
        movimentosListPane.setSpacing(BancoMS.METRICS.getPX(0.005));
        ...
        boxFiltro = new HBox();
        boxFiltro.setSpacing(BancoMS.METRICS.getPX(0.005));
        ...
        saldoBox = new HBox();
        saldoBox.setSpacing(BancoMS.METRICS.getPX(0.005));
        ...
        boxLabelCentral.setSpacing(BancoMS.METRICS.getPX(0.004));
    ...
    private void criarSaldoBox(ExtratoController extratoController) {
        ...
        labelSaldoTotal.setFont(Font.font(BancoMS.METRICS.getPX(0.008)));
        ...
        labelDiferencial.setFont(Font.font(BancoMS.METRICS.getPX(0.008)));
        ...
        labelsaldoSemDiferencial.setFont(Font.font(BancoMS.METRICS.getPX(0.008)));
