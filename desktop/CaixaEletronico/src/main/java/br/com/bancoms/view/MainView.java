...
public class MainView extends StackPane {
    ...
    private void initBar() {
        ...
        Rectangle rectangle = new Rectangle(BancoMS.METRICS.getPX(BancoMS.METRICS.getWidth()),
                BancoMS.METRICS.getPX(0.024));
        ...
        topBar.setTranslateY(BancoMS.METRICS.getY(-0.475));


        Rectangle rectLogo = new Rectangle();
        StackPane logo = new StackPane();
        rectLogo.setWidth(BancoMS.METRICS.getPX(0.080));
        rectLogo.setHeight(BancoMS.METRICS.getPX(0.017));
        ...
        logo.setPrefSize(rectLogo.getWidth(), rectLogo.getHeight());
        logo.setTranslateX(BancoMS.METRICS.getX(-0.350));

        Text fontLogo = new Text("Banco M&S");
        fontLogo.setFont(Font.font(BancoMS.METRICS.getPX(0.010)));
        ...
        rectSubMenuCliente.setWidth(BancoMS.METRICS.getPX(0.080));
        rectSubMenuCliente.setHeight(BancoMS.METRICS.getPX(0.017));
        ...
        subMenuCliente.setPrefSize(rectLogo.getWidth(), rectLogo.getHeight());
        subMenuCliente.setTranslateX(BancoMS.METRICS.getX(0.320));

        labelClienteNome = new Label();
        labelClienteNome.getStyleClass().add("labelStyle2");
        labelClienteNome.setFont(Font.font(BancoMS.METRICS.getPX(0.007)));
        labelClienteNome.setTranslateX(BancoMS.METRICS.getX(0.190));

        labelClienteTipoConta = new Label();
        labelClienteTipoConta.getStyleClass().add("labelStyle2");
        labelClienteTipoConta.setFont(Font.font(BancoMS.METRICS.getPX(0.0055)));

        labelClienteSaldo = new Label();
        labelClienteSaldo.setFont(Font.font(BancoMS.METRICS.getPX(0.0055)));
        labelClienteSaldo.getStyleClass().add("labelStyle2");

        labelMostrarSaldo = new Label("Mostrar Saldo");
        labelMostrarSaldo.setFont(Font.font(BancoMS.METRICS.getPX(0.008)));
        ...
        titleBar.setFont(Font.font(BancoMS.METRICS.getPX(0.008)));
        ...
        botaoSair.setTranslateX(BancoMS.METRICS.getX(0.400));
