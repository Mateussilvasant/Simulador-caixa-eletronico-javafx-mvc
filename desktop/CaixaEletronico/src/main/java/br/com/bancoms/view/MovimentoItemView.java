...
public class MovimentoItemView extends VBox {
    ...
    public MovimentoItemView(ExtratoController controller, Movimento movimento, int index) {
        ...
        double padding = BancoMS.METRICS.getPX(0.0050);

        boxResumo = new HBox();
        boxResumo.setSpacing(BancoMS.METRICS.getPX(0.005));
        ...
        boxDetalhes.setSpacing(BancoMS.METRICS.getPX(0.005));
        ...
        valor.setFont(Font.font(BancoMS.METRICS.getPX(0.007)));
