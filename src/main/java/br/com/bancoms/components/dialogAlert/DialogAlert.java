...
public class DialogAlert extends VBox {
    ...
    public DialogAlert(AlertType tipo, String titulo, String conteudo, Pane root, boolean background) {
        ...
        double paddingBox = SistemaCaixaEletronico.METRICS.getPX(0.0040);
        ...
        tituloLabel.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.010)));

        Label conteudoLabel = new Label(conteudo);
        conteudoLabel.getStyleClass().add("labelStyleDark");
        conteudoLabel.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.008)));

        HBox buttons = new HBox();
        buttons.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.004));
