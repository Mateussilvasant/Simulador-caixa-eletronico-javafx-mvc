...
public class TransferenciaView extends VBox {
    ...
    public TransferenciaView(TransferenciaController transferenciaController) {
        ...
        labelTitle.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.010)));

        boxTitle = new HBox();
        boxTitle.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.004));
        ...
        boxBotoesNumeroConta.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.005));
        ...
        boxValorOperacao.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.005));
