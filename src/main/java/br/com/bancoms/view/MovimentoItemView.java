...
public class MovimentoItemView extends VBox {
    ...
    public MovimentoItemView(ExtratoController controller, Movimento movimento, int index) {
        ...
        double padding = SistemaCaixaEletronico.METRICS.getPX(0.0050);

        boxResumo = new HBox();
        boxResumo.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.005));
        ...
        boxDetalhes.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.005));
        ...
        valor.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.007)));
