...
public class ExtratoView extends VBox {
    ...
    public ExtratoView(ExtratoController extratoController) {
        ...
        setFillWidth(false);
        setTranslateY(getTranslateY() + SistemaCaixaEletronico.METRICS.getPX(0.010));
        ...
        tipoMovimentoLabel.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.008)));

        Label periodoLabel = new Label("Período: ");
        periodoLabel.getStyleClass().add("labelStyleDark");
        periodoLabel.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.008)));

        labelExtrato = new TextFlow();

        Text ola = new Text("Olá ");
        ola.getStyleClass().add("labelStyleDark");
        ola.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.009)));
        ...
        nomeClient.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.009)));

        Text extratoFrase = new Text("  esse é o seu extrato de hoje");
        extratoFrase.getStyleClass().add("labelStyleDark");
        extratoFrase.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.009)));

        Text data = new Text("(" + DateUtil.currentDate() + ")");
        data.getStyleClass().add("labelStyleDarkBold");
        data.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.009)));
        ...
        movimentosListPane.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.005));
        ...
        boxFiltro = new HBox();
        boxFiltro.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.005));
        ...
        saldoBox = new HBox();
        saldoBox.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.005));
        ...
        boxLabelCentral.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.004));
    ...
    private void criarSaldoBox(ExtratoController extratoController) {
        ...
        labelSaldoTotal.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.008)));
        ...
        labelDiferencial.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.008)));
        ...
        labelsaldoSemDiferencial.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.008)));
