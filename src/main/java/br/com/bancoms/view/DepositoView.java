...
public class DepositoView extends VBox {
    ...
    public DepositoView(DepositoController controller) {
        ...
        labelDeposito.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.012)));
        ...
        labelDepositoTipo.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.010)));
        ...
        labelNumerConta.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.010)));

        fieldNumeroConta = new TextField();
        fieldNumeroConta.setEditable(false);
        fieldNumeroConta.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.010)));
        fieldNumeroConta.getStyleClass().add("fieldStyle");


        formNumeroConta = new HBox();
        formNumeroConta.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.004));
        ...
        opcoesConta.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.004));
        ...
        botoesOutraConta.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.005));
        ...
        botoesInserirValor.setSpacing(SistemaCaixaEletronico.METRICS.getPX(0.005));
