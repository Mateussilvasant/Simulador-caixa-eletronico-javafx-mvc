...
public class MainView extends StackPane {
    ...
    private void initBar() {
        ...
        Rectangle rectangle = new Rectangle(SistemaCaixaEletronico.METRICS.getPX(SistemaCaixaEletronico.METRICS.getWidth()),
                SistemaCaixaEletronico.METRICS.getPX(0.024));
        ...
        topBar.setTranslateY(SistemaCaixaEletronico.METRICS.getY(-0.475));


        Rectangle rectLogo = new Rectangle();
        StackPane logo = new StackPane();
        rectLogo.setWidth(SistemaCaixaEletronico.METRICS.getPX(0.080));
        rectLogo.setHeight(SistemaCaixaEletronico.METRICS.getPX(0.017));
        ...
        logo.setPrefSize(rectLogo.getWidth(), rectLogo.getHeight());
        logo.setTranslateX(SistemaCaixaEletronico.METRICS.getX(-0.350));

        Text fontLogo = new Text("Banco M&S");
        fontLogo.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.010)));
        ...
        rectSubMenuCliente.setWidth(SistemaCaixaEletronico.METRICS.getPX(0.080));
        rectSubMenuCliente.setHeight(SistemaCaixaEletronico.METRICS.getPX(0.017));
        ...
        subMenuCliente.setPrefSize(rectLogo.getWidth(), rectLogo.getHeight());
        subMenuCliente.setTranslateX(SistemaCaixaEletronico.METRICS.getX(0.320));

        labelClienteNome = new Label();
        labelClienteNome.getStyleClass().add("labelStyle2");
        labelClienteNome.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.007)));
        labelClienteNome.setTranslateX(SistemaCaixaEletronico.METRICS.getX(0.190));

        labelClienteTipoConta = new Label();
        labelClienteTipoConta.getStyleClass().add("labelStyle2");
        labelClienteTipoConta.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.0055)));

        labelClienteSaldo = new Label();
        labelClienteSaldo.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.0055)));
        labelClienteSaldo.getStyleClass().add("labelStyle2");

        labelMostrarSaldo = new Label("Mostrar Saldo");
        labelMostrarSaldo.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.008)));
        ...
        titleBar.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(0.008)));
        ...
        botaoSair.setTranslateX(SistemaCaixaEletronico.METRICS.getX(0.400));
