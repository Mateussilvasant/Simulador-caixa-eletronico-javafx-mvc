...
public class View {
    ...
    public static Button createButton(String nome, String style, double width, double height, double size) {
        ...
        button.setFont(Font.font(SistemaCaixaEletronico.METRICS.getPX(size)));
        button.setStyle("-fx-font-size: " + SistemaCaixaEletronico.METRICS.getPX(size) + ";");
    ...
    public static void setSizeElemento(Region region, double width, double height) {
        double w = SistemaCaixaEletronico.METRICS.getPX(width, true);
        double h = SistemaCaixaEletronico.METRICS.getPX(height, false);
